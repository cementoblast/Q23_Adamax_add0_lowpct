...
if __name__ == '__main__':
    ...
    dbx_study_fname = f'/qnt_Adamax_add0_lowpct_norm.pkl'
    local_study_fname = f'{folder}{dbx_study_fname}'
    dbx_params_fname = f'/params_Adamax_add0_lowpct_norm.csv'
    local_params_fname = f'{folder}{dbx_params_fname}'
    dbx_df_fname = f'/qnt_Adamax_add0_lowpct_norm.csv'
    local_df_fname = f'{folder}{dbx_df_fname}'
    dbx_wt_fname = f'/wt_Adamax_add0_lowpct_norm.csv'
    local_wt_fname = f'{folder}{dbx_wt_fname}'
    dbx_long_model_fname = f'/long_model_Adamax_add0_lowpct_norm.pt'
    local_long_model_fname = f'{folder}{dbx_long_model_fname}'
    dbx_short_model_fname = f'/short_model_Adamax_add0_lowpct_norm.pt'
    ...
    def train(model, opt, trade_type: int, hold_period: int, update_cnt: int, return_dict: dict):
        ...
        for fst_date in true_train_dates:
            ...
            if train_cnt % update_cnt == 0:
                ...
                Returns = normalize(scaled_cumsum * discount_factors + ret_ * (gamma ** tarange(1, update_cnt + 1)), dim = 0)
